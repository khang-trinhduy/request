...
namespace Request.API.Migrations
{
    ...
    [Migration("20190403103352_remove-activity-on-data")]
    partial class removeactivityondata
    {
            ...
            modelBuilder.Entity("Request.API.Models.ActivityAdapter", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("ActivityAdapter");
                });
            ...
            modelBuilder.Entity("Request.API.Models.EmailActivityOperator", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("EmailActivityOperator");
                });

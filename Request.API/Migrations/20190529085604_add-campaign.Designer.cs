...
namespace Request.API.Migrations
{
    ...
    [Migration("20190529085604_add-campaign")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Request.API.Models.CampaignActivityOperator", b =>
                {
                    b.HasBaseType("Request.API.Models.Activity");
            ...
            modelBuilder.Entity("Request.API.Models.EmailActivityOperator", b =>
                {
                    ...
                    b.Property<int?>("AdapterId")
                        .HasColumnName("EmailActivityOperator_AdapterId");
            ...
            modelBuilder.Entity("Request.API.Models.Campaign", b =>
                {
                    b.HasBaseType("Request.API.Models.Data");
            ...
            modelBuilder.Entity("Request.API.Models.Contact", b =>
                {
                    b.HasBaseType("Request.API.Models.Data");

                    b.Property<int>("Age");

                    b.Property<int?>("CampaignActivityOperatorId");
                    ...
                    b.HasIndex("CampaignActivityOperatorId");
            ...
            modelBuilder.Entity("Request.API.Models.Contact", b =>
                {
                    b.HasOne("Request.API.Models.CampaignActivityOperator")
                        .WithMany("Subscribers")
                        .HasForeignKey("CampaignActivityOperatorId");

                    b.HasOne("Request.API.Models.Campaign")
                        .WithMany("Subscribers")

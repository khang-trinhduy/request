#pragma checksum "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\Create.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8e38c0afa4da2e8975306faa71026d6b3f4101d3"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8e38c0afa4da2e8975306faa71026d6b3f4101d3", @"/Views/Requests/Create.cshtml")]
...
#line hidden
    ...
    <div id=""request-title"">
        ...
        <div class=""custom-control custom-radio"">
            <input type=""radio"" id=""tree-proceed"" ");
...
<div class=""state-area"">
    <div class=""add-state-area"">
        ...
        ");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("select", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8e38c0afa4da2e8975306faa71026d6b3f4101d35608", async() => {
                BeginContext(1435, 14, true);
                WriteLiteral("\r\n            ");
                EndContext();
                BeginContext(1449, 33, false);
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8e38c0afa4da2e8975306faa71026d6b3f4101d36006", async() => {
...
#line 29 "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\Create.cshtml"
...
<div class=""progress-page"">
    ...
    <button class=""btn btn-info"" onclick=""a");
            WriteLiteral(@"dd_trigger()"">Thêm trigger</button>
...
<script>
    ...
    var config_url = ""https://10.3.236.232:443/api/v1/requests/triggerconfig"";
    var trigger_configuration = {};
    $(function (){ //FIXME cannot read json file from config_url
        $.getJSON(config_url, function(data) {
            trigger_configuration = JSON.parse(data);
        });
    });
    function add_trigger(id) { /*TODO get id to add trigger*/
        activate_trigger = true;
        if (trigger_configuration == null) {
            alert(""cannot read configuration file, make sure that url { "" + config_url + "" } is valid"");
        }
        var options = [];
        trigger_configuration.forEach(element => {
            options.push(element.name);
        });
        var for = add_select(""Trigger for"", ""trigger-for"" + id.toString(), options); /*TODO append to trigger-content*/
    }
    function a");
            WriteLiteral(@"dd_select(name, id, options) { /*TODO add function to append new select*/
    ...
    function generate_path() {
        ...
        if (!tree) {
            ...
            for (let i = 0; i < ids.length - 1; i++) {
                ...
                var activity = {};
                activity['name'] = $('");
            WriteLiteral(@"#activity-name' + cur.toString()).val();
    ...
    function add_path(i) {
        i = cc;
        var elem = '<div><select style=""display: inline-block"" class=""for");
            WriteLiteral(@"m-control"" id=""current-node' + (i + 1).toString() + '"">';
        for (let j = 0; j < ids.length;j++) {
            const ai = ids[j];
            var name = $('#activity-name' + ai.toString()).val();
            elem += '<option value=""' + name + '"">' + name + '</option>';
    ...
    function createstate(id, type) {  
        var state_view = '<div class=""state-header"">' +
            ...
            '<select hidden class=""form-");
            WriteLiteral(@"control"" id=""state-type' + id + '"">' +
        ...
        switch (type) {
         ...
         ");
            WriteLiteral(@"                               '<option selected value=""crm"">Bộ phận nghiệp vụ</option>' +
                        ...
                        '<div class=""trigger-area"">' +
                            ...
                            '<select class=""form-control"" id=""trigger-cons' + id + '"">' +
                                '<option selected selected value=""campaign"">campaign</option>' +
                                '<option v");
            WriteLiteral(@"alue=""other"">Khác</option>' +
                            '</select>' +
            ...
            WriteLiteral(@"r"">Khác</option>' +
                                    ...
                                    '</select>' + 
                                    '<input style=""display:inline-block"" type=""text"" class=""f");
            WriteLiteral(@"orm-control"" id=""trigger-thre' + id +'"">' + 
                                '</div>' +
                            '</div>' +
                        '</div>' +
                        '<hr/></div>';
            ...
            case 'CONTACT':
                state_view += '<div class=""contact-contents"">' +
                        ...
                        '<input type=""text"" class=""form-control"" placeholder=""Mô tả nội dung công việc"" id=""activity-desc' + id + '""></div>' +
                        '<a class=""control-label"" onclick=""toggling(this)"">Thời gian thực hiện công việc (giờ): </a> <input type=""number"" class=""form-control"" id=""activity-dura' + id + '"">' +
                        '<div style=""display:block""><label class=""control-label"">Họ & tên</lab");
            WriteLiteral(@"el>' +
                        ...
                        '</div></div>' +
                        '<div class=""role-area""><span hidden>Đối tượng thực hiện (chọn 1 hoặc nhiều): </span>' +
                                    '<select hidden class=""form-control"" id=""role-typ");
            WriteLiteral(@"e' + id + '"" multiple>' +
                                        '<option selected selected value=""hr"">Bộ phận nhân sự</option>' +
            ...
            case 'ABSENT':
                if ($('#manual-proceed').is(':checked')) {
                    state_view += '<div class=""absent-contents"">' +
                            ...
                            '<a hidden onclick=""toggling()"" class=""control-label"">M");
            WriteLiteral(@"ô tả chi tiết</a>' +
                            ...
                            '<textarea class=""form-control"" placeholder=""Lý do"" rows=""3"" id=""activity-reason' + id + '"">Có việc gấp</textare");
            WriteLiteral(@"a>' +
      ...
      ");
            WriteLiteral(@"      case 'EMAIL':
                state_view += '<div class=""email-container"">' + 
                    ...
                    '<div class=""email-body"">' +
                        '<label class=""control-label"" id=""email-content""></label><textarea class=""form-control"" ");
            WriteLiteral(@"rows=""5"" id=""contents""></textarea>' +
                    '</div>' +
            ...
            case 'GENERIC':
                state_view += '<div class=""generic-contents"">' +
                        ...
                        '<div><a id=""detail-label"" onclick=""to");
            WriteLiteral(@"ggling(this)"" class=""control-label"">Mô tả chi tiết</a>' +
                        '<input type=""text"" class=""form-control"" placeholder=""Mô tả nội dung công việc"" id=""activity-desc' + id + '""></div>' +
                        '<a class=""control-label"" onclick=""toggling(this)"">Thời gian thực hiện công việc (giờ): </a> <input type=""number"" class=""form-control"" id=""activity-dura' + id + '"">' +
    ...
    function add_transition(i) {
        ...
        '<select style=""display: inline-block"" class=""form-control"" id=""select-c");
            WriteLiteral(@"ond' + i + '"">';
 ...
 ");
   ...
   ");
            WriteLiteral(@"             if (action == undefined || action == '') {
                    return null;
                }
                console.log(""tree"");        
    ...
    $('#btn-submit').on('click', function (params) {
        ...
        for (let i = 1; i <= ids.length; i++) {
            ...
            if (tree) {
                ...
                node['description'] = activity['description'] = $('#activi");
            WriteLiteral(@"ty-desc' + i.toString()).val();
            ...
            WriteLiteral(@"  });
                ...
                activity['roles'] = [];
                activity['absentname'] = $('#activity-worker' + i.toString()).val();
                activity['dayoff'] = $('#activity-off-da");
            WriteLiteral(@"y' + i.toString()).val();
                <!-- activity['isreallynotapproved'] = $('#activity-reason' + i.toString()).val(); -->
                <!-- activity['approvername'] = $('#activity-worker' + i.toString()).val(); -->
                activity['reason'] = $('#activity-reason' + i.toString()).val();
                roles.forEach(element => {
            ...
            WriteLiteral(@"ctivity.name);
                ...
                request['process']['states'].push(sta");
            WriteLiteral(@"te);
            }
        ...
        if (!manual && !tree) {
            ...
            if (cdt > 1) {
                for (let i = 1; i < cdt; i++) {
                    ...
                    another_rule['currentstate'] = $('#select-cond' + i.toString");
            WriteLiteral(@"()).val();                     
                    ...
                    if (!is_not_duplicated) {
                        request['process']['rules'].push(another_");
            WriteLiteral(@"rule);                 
                    }
                }
            }
        ...
        if (tree) {
            ...
            request['process']['nodes'].forEach(node => {
                if (node.parent == null || node.parent == undefined || node.parent == '') {
                    ...
                    var parent = r");
            WriteLiteral(@"equest['process']['nodes'][request['process']['nodes'].findIndex(i => i.name == node.parent)];
                    if (parent != null) {
...
#line 766 "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\Create.cshtml"
                 Write(Url.Action("createtree", "requests"));

#line default
#line hidden
            EndContext();
            BeginContext(39303, 543, true);
            WriteLiteral(@"',
                data: request,
                dataType: ""json"",
                header: {
            ...
            $.ajax({
                ...
                url: '");
            EndContext();
            BeginContext(39847, 32, false);
#line 784 "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\Create.cshtml"
                 Write(Url.Action("create", "requests"));

#line default
#line hidden
            EndContext();
            BeginContext(39879, 484, true);
            WriteLiteral(@"',
                data: request,
                dataType: ""json"",
                header: {

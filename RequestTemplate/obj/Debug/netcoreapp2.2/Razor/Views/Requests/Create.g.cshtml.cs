#pragma checksum "C:\Users\trinh\source\WTF\API\Request\RequestTemplate\Views\Requests\Create.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "fe6e43b36bd2ba2b48467734bbdfe8b0de248ec7"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"fe6e43b36bd2ba2b48467734bbdfe8b0de248ec7", @"/Views/Requests/Create.cshtml")]
...
<div class=""state-area"">
    <div class=""add-state-area"">
        ...
        ");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("select", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "fe6e43b36bd2ba2b48467734bbdfe8b0de248ec75584", async() => {
                BeginContext(1435, 14, true);
                WriteLiteral("\r\n            ");
                EndContext();
                BeginContext(1449, 33, false);
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "fe6e43b36bd2ba2b48467734bbdfe8b0de248ec75982", async() => {
    ...
    function generate_path() {
        ...
        if (!tree) {
            for (let i = 0; i < ids.length; i++) {
              ...
              ");
            WriteLiteral(@"  var elem = '<select onchange=""change(this,' + (i + 1).toString() +')"" style=""display: inline-block"" class=""form-control"" id=""state-graph' + (i + 1).toString() + '"">';
            ...
            for (let i = 0; i < ids.length - 1; i++) {
                ...
                elem += '</select><div style=""display: inline-block"" class=""path"">' + 
                        '<p style=""display:inline-block"">--</p>' +
                        '</div>';
                elem += '<input id=""node-action' + (i + 1).toString() + '"" class=""form-control"" placeholder=""action"" style=""display:inline-block; width: a");
            WriteLiteral(@"uto"" />';
                if (i < ids.length - 1) {
                    elem += '<div style=""display: inline-block"" class=""path"">' + 
                        '<p style=""display:inline-block"">--></p>' +
            ...
            cc = ids.length - 1;
            // elem += '<input type=""button"" class=""btn btn-info"" value=""Thêm nhánh"" onclick=""add_path('");
            WriteLiteral(@" + cc + ')""/>';
            $('.progress-area').append(elem);
        }
 ...
 ");
    ...
    function default_condition(params) {
        ...
        for (let i = 0; i < params.length; i++) {
            if (i < params.length - 1) {
                ...
                new_elem += '<li class=""list-group");
            WriteLiteral(@"-item disabled"">Nếu ' + params[i] + ' chọn approve thì kết thúc quy trình</li>';
            }
        }
        new_elem += '</ul>';
    ...
    function createstate(id, type) {  
        var state_view = '<div class=""state-header"">' +
            ...
            '</label>' +
");
            WriteLiteral(@"            '<input hidden id=""state-name' + id + '"" type=""text"" class=""form-control""/>' +
        ...
        switch (type) {
            ...
            WriteLiteral(@"aceholder=""Tên công việc"" id=""activity-name' + id + '"" value=""Add/Select a campaign"">' +
                  ...
                  ");
            WriteLiteral(@"                  '<select hidden class=""form-control"" id=""role-type' + id + '"" multiple>' +
                     ...
                     ");
            WriteLiteral(@"       '<select class=""form-control"" id=""trigger-cons' + id + '"">' +
                                '<option selected selected value=""campaign"">campaign</option>' +
                                '<option value=""other"">Khác</option>' +
                            '</select>' +
                            ...
                            '<div class=""condition-area"">' +   
                                ...
                                '<div class=""events"" style=""display: inline-block"">' +
                                    ...
                                    '<select class=""form-control"" id=""trigger-even'");
            WriteLiteral(@" + id + '"" style=""display: inline-block"">' +
                      ...
                      ");
            WriteLiteral(@"                  '<option value=""lesserorequal""><=</option>' +
                                    '</select>' + 
            ...
            case 'CONTACT':
                state_view += '<div class=""contact-contents"">' +
                        ...
                        '<div><a id=""detail-label"" onclick=""toggling(this)"" class=""control-label"">Mô tả chi tiết</a>' +
                        '<input type=""text"" class=""form-control"" placeholder=""Mô tả nội dung công việc"" id=""activity-desc' + id + '""></div>' +
                        '<a class=""control-label"" onclick=""toggling(this)"">Th");
            WriteLiteral(@"ời gian thực hiện công việc (giờ): </a> <input type=""number"" class=""form-control"" id=""activity-dura' + id + '"">' +
            ...
            case 'ABSENT':
                if ($('#manual-proceed').is(':checked')) {
                    state_view += '<div class=""absent-contents"">' +
                          ");
            WriteLiteral(@"  '<input type=""text"" class=""form-control"" placeholder=""Tên công việc"" id=""activity-name' + id + '"" value=""Xin nghỉ phép"">' +
         ...
         ");
            WriteLiteral(@"                   '<label class=""control-label"">Lý do: </label>' + 
            ...
            case 'EMAIL':
                state_view += '<div class=""email-container"">' + 
                    '<div class=""email-header"">' +
                        ...
                        '<label class=""control-label"" id=""subject"">Subject: </label><input class=""form-control"" id=""subject"" type=""text"" placeholde");
            WriteLiteral(@"r="""" />' +
                        '</div>' +
            ...
            WriteLiteral(@"div class=""generic-contents"">' +
                        ...
                        '<div class=""role-area""><label class=""control-label"">Đối tượng thực hiện (chọn 1 hoặc nhiều):</label>' +
                                '<select class=""form-control"" id=""role-type' + id + '"" multiple>' +
                                    '<option value=""hr"">Bộ phậ");
            WriteLiteral(@"n nhân sự</option>' +
    ...
    funct");
            WriteLiteral(@"ion toggling(self) {
    ...
    function get_rule() {
        ...
        if (!tree) {
            ...
            for (let i = 1; i <= cc; i++) {
                ...
                var action = $('#node-action' + cur.toString()).");
            WriteLiteral(@"val();
  ...
  ");
            WriteLiteral(@"      request['process']['actions'] = [];
        ...
        for (let i = 1; i <= ids.length; i++) {
            ...
            WriteLiteral(@" [];
                ...
                activity['campaign']
               ");
            WriteLiteral(@" roles.forEach(element => {
        ...
        ");
            WriteLiteral(@"                    is_not_duplicated = false;
                        }
                    }
        ...
        i");
            WriteLiteral("f (tree) {\r\n            $.ajax({\r\n                type: \"post\",\r\n                url: \'");
            EndContext();
            BeginContext(38453, 36, false);
#line 749 "C:\Users\trinh\source\WTF\API\Request\RequestTemplate\Views\Requests\Create.cshtml"
                 Write(Url.Action("createtree", "requests"));

#line default
#line hidden
            EndContext();
            BeginContext(38489, 543, true);
            WriteLiteral(@"',
                data: request,
                dataType: ""json"",
                header: {
            ...
            $.ajax({
                ...
                url: '");
            EndContext();
            BeginContext(39033, 32, false);
#line 767 "C:\Users\trinh\source\WTF\API\Request\RequestTemplate\Views\Requests\Create.cshtml"
                 Write(Url.Action("create", "requests"));

#line default
#line hidden
            EndContext();
            BeginContext(39065, 484, true);
            WriteLiteral(@"',
                data: request,
                dataType: ""json"",
                header: {

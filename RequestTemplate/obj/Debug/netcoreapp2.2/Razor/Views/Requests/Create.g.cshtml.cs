#pragma checksum "C:\Users\trinh\source\WTF\API\Request\RequestTemplate\Views\Requests\Create.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5fab8104a30e85b1ac5309095dba80f37d374ee4"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5fab8104a30e85b1ac5309095dba80f37d374ee4", @"/Views/Requests/Create.cshtml")]
    ...
    public class Views_Requests_Create : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#line 1 "C:\Users\trinh\source\WTF\API\Request\RequestTemplate\Views\Requests\Create.cshtml"
...
<div class=""state-area"">
    <div class=""add-state-area"">
        ...
        ");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("select", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "5fab8104a30e85b1ac5309095dba80f37d374ee45584", async() => {
                BeginContext(1435, 14, true);
                WriteLiteral("\r\n            ");
                EndContext();
                BeginContext(1449, 33, false);
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "5fab8104a30e85b1ac5309095dba80f37d374ee45982", async() => {
...
#line 29 "C:\Users\trinh\source\WTF\API\Request\RequestTemplate\Views\Requests\Create.cshtml"
...
<script>
    ...
    function add_select(name, id, options) { /*TODO add function to append new select*/
        var elem = '<lab");
            WriteLiteral(@"el class=""control-label"">' + name + '</label>' +
        ...
        if (!tree) {
            for (let i = 0; i < ids.length; i++) {
                ...
                for (let j = 0; j < ids.length; j++) {
                    const ai = ids[j];
                    var name ");
            WriteLiteral(@"= $('#activity-name' + ai.toString()).val();
            ...
            for (let i = 0; i < ids.length - 1; i++) {
                ...
                var activity = {};
                activity['name'] = $('#activity-name' + cur.toString()).val();
                elem += '<div><select style=""display: inl");
            WriteLiteral(@"ine-block"" class=""form-control"" id=""current-node' + (i + 1).toString() + '"">';
                ...
                elem += '<select style=""display: ");
            WriteLiteral(@"inline-block"" class=""form-control"" id=""next-node' + (i + 1).toString() + '"">';
    ...
    function add_path(i) {
        ...
        for (let j = 0; j < ids.length;j++) {
            ...
            var name = $('#activity-name' + ai.toString()).val();
            elem += '<");
            WriteLiteral(@"option value=""' + name + '"">' + name + '</option>';
        }
        elem += '</select></div>';
        cc++;
        $('.progress-area').append(elem);
        ...
        switch (type) {
            case 'CAMPAIGN':
                state_view += '<div class=""campaign-contents"">' +
                        ...
                        '<input type=""text"" class=""form-control"" placeholder=""Mô tả nội dung công ");
            WriteLiteral(@"việc"" id=""activity-desc' + id + '""></div>' +
       ...
       ");
            WriteLiteral(@"                                 '<option value=""other"">Khác</option>' +
                        ...
                        '<div class=""trigger-area"">' +
                            ...
                            '</select>' +
                         ");
            WriteLiteral(@"   '<label class=""control-label"">To:</label>' +
                            ...
                            '<div class=""condition-area"">' +   
                                ...
                                '<div class=""events"" style=""display: inline-block"">' +
                                    ...
                                    '</select>' + 
                          ");
            WriteLiteral(@"          '<label class=""control-label"" style=""display: inline-block; width: auto"">If: </label>' +
         ...
         ");
            ...
            case 'CONTACT':
                state_view += '<div class=""contact-contents"">' +
                        ...
                        '<input type=""text"" class=""form-control"" placeholder=""Họ & tên"" id=");
            WriteLiteral(@"""activity-cont' + id + '"">' +
            ...
            WriteLiteral(@"=""hr"">Bộ phận nhân sự</option>' +
                                        '<option selected value=""crm"">Bộ phận nghiệp vụ</option>' +
                                        '<option value=""other"">Khác</option>' +
                                    '</select>' +
                            '</div>' +
            ...
            WriteLiteral(@"der=""Mô tả nội dung công việc"" id=""activity-desc' + id + '"">' +
  ...
  ");
            ...
            ");
            WriteLiteral(@"        '<div class=""email-header"">' +
                    ...
                    '</div>' +
                    '<div cl");
            WriteLiteral(@"ass=""email-attachment"">' +
            ...
            case 'GENERIC':
                state_view += '<div class=""generic-contents"">' +
                        ...
                        '<div><a id=""detail-label"" onclick=""toggling(this)"" class=""control-label"">Mô tả chi tiết</a>' +
                        '<input type=""te");
            WriteLiteral(@"xt"" class=""form-control"" placeholder=""Mô tả nội dung công việc"" id=""activity-desc' + id + '""></div>' +
                        '<a class=""control-label"" onclick=""toggling(this)"">Thời gian thực hiện công việc (giờ): </a> <input type=""number"" class=""form-control"" id=""activity-dura' + id + '"">' +
    ...
    function add_transition(i) {
        ...
        activities.forEach(activity => {
            elem += '<option value=""' +");
            WriteLiteral(@" activity + '"">' + activity +'</option>';
        });
        elem += '</select>' +
    ...
    $('.state-icon>i').on('click', function () {
      ");
            WriteLiteral(@"  $('.states-partial').append(createstate(curId + 1, $(this).attr('id').toUpperCase()));
    ...
    function get_rule() {
        ...
        if (!tree) {
            ...
            WriteLiteral(@"-graph' + next.toString()).val();
                    rule['action'] = 'approve';
    ...
    $('#btn-submit').on('click', function (params) {
        ...
        for (let i = 1; i <= ids.length; i++) {
            ...
            if (tree) {
                ...
                activity['duration'] = $('#activity-dura' + i.toSt");
            WriteLiteral(@"ring()).val();
                ...
                if (activity.roles.length <= 0) {
                    alert('Chưa chọn đối ");
            WriteLiteral(@"tượng phụ trách công việc ' + activity.name);
                    return;
                }
                node['activities'] = [];
                ...
                activity['absentname'] = $('#activity-worker' + i.toString()).val();
                activity['dayoff'] = $('#activity-off-day' + i.toString()).val();
                <!-- activity['isreallynotapproved'] = $('#activity-reas");
            WriteLiteral(@"on' + i.toString()).val(); -->
                <!-- activity['approvername'] = $('#activity-worker' + i.toString()).val(); -->
                activity['reason'] = $('#activity-reason' + i.toString()).val();
                roles.forEach(element => {
                    if(!activity['roles'].some(e => e.name === element)) {
                ...
                if (!manual) {
                    ...
                    {
                        stat");
            WriteLiteral(@"e['statetype'] = 'start';
                    }
        ...
        if (!manual && !tree) {
            ...
            if (cdt > 1) {
                for (let i = 1; i < cdt; i++) {
                    ...
                    another_rule['nextstate'] = $('#select-answ' +");
            WriteLiteral(@" i.toString()).val();
                    if (activate_trigger) {
   ...
   ");
        ...
        if (tree) {
            $.ajax({
                ...
                url: '");
            EndContext();
            BeginContext(39168, 36, false);
#line 764 "C:\Users\trinh\source\WTF\API\Request\RequestTemplate\Views\Requests\Create.cshtml"
                 Write(Url.Action("createtree", "requests"));

#line default
#line hidden
            EndContext();
            BeginContext(39204, 543, true);
            WriteLiteral(@"',
                data: request,
                dataType: ""json"",
                header: {
            ...
            $.ajax({
                ...
                url: '");
            EndContext();
            BeginContext(39748, 32, false);
#line 782 "C:\Users\trinh\source\WTF\API\Request\RequestTemplate\Views\Requests\Create.cshtml"
                 Write(Url.Action("create", "requests"));

#line default
#line hidden
            EndContext();
            BeginContext(39780, 484, true);
            WriteLiteral(@"',
                data: request,
                dataType: ""json"",
                header: {
